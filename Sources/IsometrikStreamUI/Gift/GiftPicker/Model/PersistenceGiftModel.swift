...
class PersistenceGiftModel {
    ...
    init(id: String, giftTitle: String? = nil, giftAnimationImage: String? = nil, giftImage: String? = nil, virtualCurrency: Int? = nil, giftGroupId: String? = nil) {
        self.id = id
