//
//  StreamGiftContentGroupHeaderView.swift
//  PicoAdda
//
...
class StreamGiftContentGroupHeaderView: UIView {
    ...
    var delegate: GiftGroupActionProtocol?
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(StreamGiftGroupCell.self, forCellWithReuseIdentifier: "StreamGiftGroupCell")
...
extension StreamGiftContentGroupHeaderView: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, SkeletonCollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "StreamGiftGroupCell", for: indexPath) as! StreamGiftGroupCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: (UIScreen.main.bounds.width - 50) / 4 , height: 75)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didHighlightItemAt indexPath: IndexPath) {
        if let cell = collectionView.cellForItem(at: indexPath) as? StreamGiftGroupCell {
