...
class RestreamViewModel {
    ...
    func getChannelTypeData(forRestreamType type: RestreamChannelType) -> RestreamTypeData {
        ...
        case .youtube:
            return RestreamTypeData(staticDomainURL: "www.youtube.com/", image: ISMStreamUIAppearance.default.images.youtubeLogo)
        case .twitch:
            return RestreamTypeData(staticDomainURL: "www.twitch.com/", image: ISMStreamUIAppearance.default.images.twitchLogo)
        case .twitter:
            return RestreamTypeData(staticDomainURL: "", image: UIImage())
        case .linkedin:
            return RestreamTypeData(staticDomainURL: "", image: UIImage())
        case .custom:
            return RestreamTypeData(staticDomainURL: "www.instagram.com/", image: ISMStreamUIAppearance.default.images.instagramLogo)
        }
